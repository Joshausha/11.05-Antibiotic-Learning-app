 ...
 */
export const ORAL_ROUTE_COLORS: RouteColors = {
 ...
 */
export const IV_ROUTE_COLORS: RouteColors = {
  // Coverage level colors
 ...
 */
export const BOTH_ROUTES_COLORS: RouteColors = {
  // Coverage level colors
  none: '#ffffff',           // No coverage - pure white
 ...
 */
export const NORTHWESTERN_SEGMENT_COLORS: SegmentColors = {
 ...
 */
export const COVERAGE_ENCODING: { [key: number]: CoverageLevel } = {
  0: {
 ...
 */
export const INTERACTIVE_STATES: { [key: string]: InteractiveState } = {
  // Hover states
  hover: {
...
interface HighContrastConfig {
  ...
  segments: {
    contraindicated: HighContrastSegment;
    limited: HighContrastSegment;
    excellent: HighContrastSegment;
  };
}
 ...
 */
export const CLINICAL_HIGH_CONTRAST: HighContrastConfig = {
 ...
 */
export const COLORBLIND_SAFE_PATTERNS: { [key: string]: AccessibilityPattern } = {
 ...
 */
export const SIZE_ADAPTATIONS: { [key: string]: SizeAdaptation } = {
  small: {
    size: 120,
    borderWidth: 1,
 ...
 * @returns {RouteColors} Route color palette
 */
export const getRouteColors = (routeColor: string): RouteColors => {
  switch (routeColor) {
 ...
 * @returns {ColorConfiguration} Complete color configuration
 */
export const getSegmentColors = (segmentKey: string, routeColor: string, coverage: number): ColorConfiguration => {
 ...
 * @param {ColorConfiguration} baseColors - Base segment colors
 * @param {string} state - Interactive state ('hover', 'selected', 'focus', etc.)
 * @returns {any} Enhanced colors with interactive state
 */
export const applyInteractiveState = (baseColors: ColorConfiguration, state: string): any => {
 ...
 * @returns {HighContrastSegment} High contrast color configuration
 */
export const getHighContrastColors = (segmentKey: string, coverage: number): HighContrastSegment => {
 ...
 * @returns {any} Pattern configuration for SVG
 */
export const getAccessibilityPatterns = (coverage: number, cellWallActive: boolean = false): any => {
