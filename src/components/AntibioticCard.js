          ...
          {selectedSegment && (
            <div className="p-3 bg-white rounded-lg border border-blue-200">
              <div className="text-sm">
                ...
                <span className="ml-2">
                  {enhancedAntibiotic.northwesternSpectrum[selectedSegment] === 0 && (
                    <span className="text-red-600 font-medium">No coverage</span>
                  )}
                  {enhancedAntibiotic.northwesternSpectrum[selectedSegment] === 1 && (
                    <span className="text-yellow-600 font-medium">Moderate coverage</span>
                  )}
                  {enhancedAntibiotic.northwesternSpectrum[selectedSegment] === 2 && (
            ...
            <div className="text-sm text-gray-600">
              {Array.isArray(antibiotic.commonUses) ? (
                <ul className="space-y-1">
                  {antibiotic.commonUses.slice(0, 3).map((use, index) => (
