...
interface UserStats {
  totalQuizzes: number;
  averageScore: number;
  improvementTrend?: 'improving' | 'declining' | 'stable' | 'insufficient';
...
interface UserProgressProps {
  ...
  onViewCondition?: (condition: BookmarkedCondition) => void;
  onClearProgress?: () => void;
}

const UserProgress: React.FC<UserProgressProps> = memo(({
  userProgress,
  ...
  const stats: UserStats = userProgress?.stats || {
    totalQuizzes: 0,
    averageScore: 0,
      ...
      <div className="bg-white rounded-xl shadow-sm border p-6">
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="text-center p-4 bg-purple-50 rounded-lg">
            <div className="text-2xl font-bold text-purple-600">{stats.bestScore ?? 0}%</div>
            <div className="text-sm text-gray-600">Best Score</div>
          </div>

          <div className="text-center p-4 bg-orange-50 rounded-lg">
            <div className="text-2xl font-bold text-orange-600">{stats.streakCount ?? 0}</div>
...
UserProgress.displayName = 'UserProgress';
