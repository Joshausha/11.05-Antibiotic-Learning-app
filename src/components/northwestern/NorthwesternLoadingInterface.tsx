...
import { PriorityItemProps, ProgressBarProps, NorthwesternLoadingInterfaceProps } from '../../types/network-ui.types';

/**
 * Priority item component
 */
const PriorityItem = memo<PriorityItemProps>(({ component, index, isLoaded }) => (
 ...
 */
const NorthwesternLoadingInterface = memo<NorthwesternLoadingInterfaceProps>(({
  loadedComponents,
  loadingPriority,
  emergencyMode = false,
...
NorthwesternLoadingInterface.displayName = 'NorthwesternLoadingInterface';

export default NorthwesternLoadingInterface;
