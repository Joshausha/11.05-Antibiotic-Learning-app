 ...
 */
const NorthwesternSpatialLayoutDemo = () => {
  // Demo state
  ...
  const applyClinicalScenario = useCallback((scenarioName) => {
  ...
  return (
    <div className="northwestern-spatial-demo">
      ...
      <div className="demo-info-panel">
        ...
        {selectedAntibiotic && (
          <div className="info-section">
            ...
            <div className="antibiotic-details">
              ...
              <p><strong>Generation:</strong> {selectedAntibiotic.generation || 'N/A'}</p>
              <p><strong>Route:</strong> {selectedAntibiotic.route?.join(', ') || 'N/A'}</p>
              <p><strong>Spatial Group:</strong> {selectedAntibiotic.gridPosition?.groupName}</p>
              <p><strong>Grid Position:</strong> Row {selectedAntibiotic.gridPosition?.row + 1}, Column {selectedAntibiotic.gridPosition?.col + 1}</p>
        ...
        {selectedGroup && (
          <div className="info-section">
            <h3>Selected Group: {SPATIAL_GROUPS[selectedGroup]?.name}</h3>
            <div className="group-details">
              <p><strong>Classes:</strong> {SPATIAL_GROUPS[selectedGroup]?.classes.join(', ')}</p>
              <p><strong>Reasoning:</strong> {SPATIAL_GROUPS[selectedGroup]?.reasoning}</p>
              <p><strong>Clinical Context:</strong> {SPATIAL_GROUPS[selectedGroup]?.clinicalContext}</p>
            </div>
          </div>
        )}
      </div>
