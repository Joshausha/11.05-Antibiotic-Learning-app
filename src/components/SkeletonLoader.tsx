...
import { SkeletonLoaderProps } from '../types/component.types';
...
export const ContentSkeleton: React.FC<{ lines?: number; title?: boolean }> = ({
  lines = 3,
  title = true
}) => (
...
const SkeletonLoader: React.FC<SkeletonLoaderProps & Record<string, any>> = ({
  type = 'content',
  ...props
}) => {
  switch (type) {
