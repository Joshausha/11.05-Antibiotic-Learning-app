...
/**
 * Type definitions for Northwestern quiz questions
 */

type NorthwesternSegment =
  | 'MRSA'
  | 'VRE_faecium'
  | 'anaerobes'
  | 'atypicals'
...
interface NorthwesternQuizQuestion {
  question: string;
  options: string[];
  correct: number;
  explanation: string;
  ...
  targetSegment: NorthwesternSegment;
  visualComponent: boolean;
}

const northwesternQuizQuestions: NorthwesternQuizQuestion[] = [
  {
